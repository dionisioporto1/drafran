          ...
          >
            {PROCEDURES.map((proc, idx) => (
              <motion.div 
                ...
                className="border-r border-b border-[#1A261B]/5 transition-all group relative overflow-hidden bg-white hover:bg-[#FDFCFB] flex flex-col"
              >
                ...
                <div className="p-10 flex-1 flex flex-col">
                  <span className="text-[10px] font-mono text-[#1A261B]/30 mb-6 block">0{idx + 1}</span>
                  <h4 className="text-xl font-serif font-medium mb-4 text-[#1A261B] group-hover:text-[#D4AF37] transition-colors">{proc.name}</h4>
                  <p className="text-[#1A261B]/50 text-xs leading-relaxed mb-8 font-light flex-1">
                    {proc.description}
                  </p>
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 text-[10px] uppercase tracking-widest font-bold text-[#1A261B] group-hover:gap-5 transition-all mt-auto"
                  >
            ...
            >
              ...
              <div className="space-y-12">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#1A261B]/60">Segunda a Sexta: 09:00 — 20:00</p>
